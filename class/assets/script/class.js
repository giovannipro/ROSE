...
function load_data() {
    ...
    const apiEndpoint_class = 'assets/data/aggregated_stats_2_3.csv'
    const apiEndpoint_classInfo = 'assets/data/classInfo.json'
    const apiEndpoint_taskInfo = 'assets/data/taskInfo.json'
    const apiEndpoint_recapInfo = 'assets/data/recapInfo.json'
    const apiEndpoint_hints =  'assets/data/class_hints.json' 

    const predefined_hints = '../student/assets/content/hints.json'

    // http://127.0.0.1:5501/class/?lang=en
